...
<div id="alliancecreate-container">
	<div class="panel">
		...
		<form class="large" method="post">
			<div class="line">
				<span>
					To resurrect an alliance, please fill in the name and leader's password
				</span>
			</div>
			<div class="line">
				<label>Name:</label>
			...
			<div class="line">
				...
				<input type="text" name="alliance-password" />
			</div>
			<div class="line">
				<label>Tag:</label>
			...
			<div class="line">
				<input class="submit" type="submit" value="Create" name="alliance-submit" />
			</div>
